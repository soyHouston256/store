import TShirtBase from '@/assets/images/t-shirt/base.png'
import TShirtFilter from '@/assets/images/t-shirt/filter.png'
import TShirtBaseBack from '@/assets/images/t-shirt/base-back.png'
import TShirtFilterBack from '@/assets/images/t-shirt/filter-back.png'
...
const LogoImage = styled.img<LogoImageProps>`
    ...
    ${props => {
        // Si es back-chest y está en modo espalda, mostrar logo grande en la espalda
        if (props.$logoPosition === 'back-chest' && props.$isBack) {
            return `
                width: 35%;
                left: 50%;
                top: 30%;
        ...
        // Si es back-chest pero está en frente, usar configuración de pocket
        if (props.$logoPosition === 'back-chest' && !props.$isBack) {
            return `
                width: 23%;
                left: 30%;
